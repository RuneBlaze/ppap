...
/* -------------------------------------------------------------------------
 * sRGB ↔ OKLab conversion utilities (public domain).
 * Include this snippet at the top-level of fragment shaders that need
 * perceptually-uniform colour quantisation or blending.              
 * -------------------------------------------------------------------------*/
...
vec3 oklabToRgb(in vec3 lab)
{
    ...
    vec3 lms = vec3(L*L*L, M*M*M, S*S*S); // cubic

    float r =  4.0767416621 * lms.x - 3.3077115913 * lms.y + 0.2309699292 * lms.z;
    float g = -1.2684380046 * lms.x + 2.6097574011 * lms.y - 0.3413193965 * lms.z;
    float b = -0.0041960863 * lms.x - 0.7034186147 * lms.y + 1.7076147010 * lms.z;
